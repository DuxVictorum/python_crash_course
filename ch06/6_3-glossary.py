...
coding_terms = {
    ...
    'conditional': 'statement that will execute only if the '
...
print(f"\tstring: \t{coding_terms['string']}")
print(f"\tnumber: \t{coding_terms['number']}")
print(f"\tlist: \t\t{coding_terms['list']}")
print(f"\tconditional: \t{coding_terms['conditional']}")
print(f"\tmethod: \t{coding_terms['method']}")